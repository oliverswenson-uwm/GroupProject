...
class TestArchiveValid(TestCase):

    def setUp(self):
        client = None
        client = Client()

    def testSuccessfulArchiveOne(self):
        ...
        resp = self.client.post("/archiveacc/", {"email": "Archivethisadmin@gmail.com", "username": "adminarchive", "password": "adminarchiveme",
                                                 "accType": "Admin"
                                                 }, follow=True)
        self.assertEqual("Success! Archived account.", resp.context["msg"], "Account didn't archive but it shouldve")


    def testSuccessfulArchiveTwo(self):
    ...
    def testSuccessfulWithMissingInfo(self):
